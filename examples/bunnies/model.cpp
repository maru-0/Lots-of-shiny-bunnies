...
void Model::render(glm::vec3 pos, float angle,glm::vec3 axis,glm::vec3 scale, GLint modelMatrixLoc, GLint normalMatrixLoc, glm::mat3 normalMatrix){
  ...
  GLsizei numIndices = m_indices.size() ;
